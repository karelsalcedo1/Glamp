...
public class ListDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListaDevice = (ListView) findViewById(R.id.idlist);
        ...
        public void onResume()
        {
            ...
            ListaDevice.setAdapter(mPairedDevicesArrayAdapter);
            ListaDevice.setOnItemClickListener(mDeviceClickListener);
        ...
        private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
                ...
                Intent i = new Intent(ListDeviceActivity.this, MenuActivity.class);
